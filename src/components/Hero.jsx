  ...
  return (
    ...
    text-center w-full overflow-hidden text-gray-700 dark:text-white'>
        ...
        turning imagination into <span className='bg-gradient-to-r from-[#5044E5] to-[#4d8cea] bg-clip-text text-transparent'>digital</span> impact.</h1>
         <p className='text-sm sm:text-lg font-medium text-gray-500 dark:text-white/75 max-w-4/5 sm:max-w-lg pb-3'>Create meaningful digital experiences that leave a lasting impression on users.</p>
